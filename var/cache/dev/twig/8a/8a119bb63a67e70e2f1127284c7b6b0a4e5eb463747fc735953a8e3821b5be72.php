...
/* baseadmin.html.twig */
class __TwigTemplate_87af1eff0c77aa6bed2f1e1e85c73863763e9a8577b8e1891f38a7adb30dd029 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_top($context, array $blocks = [])
    {
        ...
        <div class=\"row\">
            <div class=\"col-6 text-left\">
                <img src=\"";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "getBasePath", [], "method", false, false, false, 14) . "/adminbanniere.jpg"), "html", null, true);
        yield "\" alt=\"img banniere\" >
            </div>
            <div class=\"col-6 d-flex align-items-center\">
                <h2 class=\"\"><strong>🚧 Back office 🚧</strong></h2>
            </div>
        </div>
        <!-- menu -->
...
";
    ...
    {
        return array (  227 => 53,  210 => 47,  204 => 43,  194 => 42,  175 => 41,  159 => 36,  151 => 31,  145 => 28,  139 => 25,  125 => 14,  117 => 9,  112 => 6,  102 => 5,  83 => 4,  64 => 3,  41 => 1,);
    }
...
{% block top %}
    <div class=\"container\">
        ...
        <div class=\"row\">
            <div class=\"col-6 text-left\">
                <img src=\"{{ app.request.getBasePath()~'/adminbanniere.jpg' }}\" alt=\"img banniere\" >
            </div>
            <div class=\"col-6 d-flex align-items-center\">
                <h2 class=\"\"><strong>🚧 Back office 🚧</strong></h2>
            </div>
...
{% endblock %}
{% block javascripts %}{% endblock %}", "baseadmin.html.twig", "C:\\wamp64\\www\\mediatekFormation\\templates\\baseadmin.html.twig");
    }
}
