...
/* basefront.html.twig */
class __TwigTemplate_f7c47aeafab1388742706b9aea07fdec extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_top($context, array $blocks = [])
    {
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            ...
            yield "\" class=\"link-dark\">se déconnecter ➜</a>
            </div>
        ";
        }
        // line 12
        ...
        <div class=\"text-left\">
            <img src=\"";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "getBasePath", [], "method", false, false, false, 14) . "/banniere.jpg"), "html", null, true);
        yield "\" alt=\"img banniere\" >
        </div>
        <!-- menu -->
...
";
    ...
    {
        return array (  228 => 49,  211 => 43,  205 => 39,  195 => 38,  176 => 37,  160 => 32,  152 => 27,  146 => 24,  140 => 21,  130 => 14,  126 => 12,  120 => 9,  117 => 8,  115 => 7,  112 => 6,  102 => 5,  83 => 4,  64 => 3,  41 => 1,);
    }
...
{% block top %}
    <div class=\"container\">
        ...
        <!-- titre -->
        <div class=\"text-left\">
            <img src=\"{{ app.request.getBasePath()~'/banniere.jpg' }}\" alt=\"img banniere\" >
        </div>
        <!-- menu -->
        <nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
            <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
            ...
            <div class=\"nav-item justify-content-md-end navbar-nav\">
                <a class=\"nav-link\" href=\"{{ path('admin.formations') }}\">Admin</a>
            </div>
        </nav>
    </div>
{% endblock %}
...
{% endblock %}
{% block javascripts %}{% endblock %}", "basefront.html.twig", "C:\\wamp64\\www\\mediatekFormation\\templates\\basefront.html.twig");
    }
}
