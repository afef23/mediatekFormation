 ...
 */
class getKeycloakldRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KeycloakldRepository' shared autowired service.
     *
     * @return \App\Repository\KeycloakldRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KeycloakldRepository.php';

        return $container->privates['App\\Repository\\KeycloakldRepository'] = new \App\Repository\KeycloakldRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
